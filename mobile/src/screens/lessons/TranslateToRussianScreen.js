...
const TranslateToRussianScreen = ({ route, navigation }) => {
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.content}>
          <Text style={styles.title}>Переведите на русский</Text>
          
          <View style={styles.questionBox}>
            <Text style={styles.question}>{lesson.targetText}</Text>
          </View>
...
export default TranslateToRussianScreen;